...
## Если по схеме только с диодами тахометр ведёт себя плохо {#tach-issues-diodes-only}
...
- [Двухконтурное БСЗ](guide/schemes/dual-circuit.md) — принцип схемы двух контуров.
- [Сборка системы по схеме](build-circuit.md).
