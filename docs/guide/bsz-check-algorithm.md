...
- [Датчик Холла](../components/hall-sensor.md) — устройство и доработка.
- [Коммутатор 76.3774](../components/commutator-763774.md).
- [Жгут проводки БСЗ](../components/wiring-harness-dbsz.md).
- [Настройка момента зажигания](ignition-timing.md) — следующий шаг после успешной проверки.
- [Проблемы и решения](problems-and-solutions.md) — если искра нестабильная или пропадает.
