# Одноконтурное БСЗ {#single-circuit-bsz}
...
## Преимущества перед КСЗ {#advantages-over-points}
...
## Альтернатива — двухконтурная схема {#alternative-dual-circuit}
...
- [Руководство → Сборка системы](build-circuit.md) · [Алгоритм проверки БСЗ](bsz-check-algorithm.md).
