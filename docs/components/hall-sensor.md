# Датчик Холла ВАЗ 2108 {#hall-sensor-vaz-2108}
...
## Роль датчика в зажигании {#hall-role-in-ignition}
...
### Особенности датчиков ВАЗ {#vaz-hall-particulars}
...
## Полярность магнитов {#magnet-polarity}
...
### Как проверить полярность {#check-polarity}
...
Если полярность втулки верна, а искры нет — см. [алгоритм проверки БСЗ](guide/bsz-check-algorithm.md).

## Рекомендации для комплектов «Неодим» {#neodim-kit-recommendations}
...
#### Одноконтурный комплект (1 шт.) {#single-circuit-kit-one-sensor}
...
#### Двухконтурный комплект (2 шт.) {#dual-circuit-kit-two-sensors}
...
- [Руководство → Доработка датчика Холла](guide/hall-sensor-mod.md).
- [Руководство → Алгоритм проверки БСЗ](guide/bsz-check-algorithm.md) — проверка правильности доработки.
- [Коммутатор 76.3774](commutator-763774.md) — пара датчику по сигнальной цепи.
- [Проблемы и решения → Датчик Холла и полярность](guide/problems-and-solutions.md#hall-sensor-polarity).
