...
![Фрагмент подключения тахометра через два диода](../assets/wiki/schem-tacho-2diode-only.jpg){ width="720" }

Полная принципиальная схема включения тахометра, замка зажигания, двух коммутаторов, двух датчиков Холла и двух катушек:

![Подключение тахометра при двухконтурном БСЗ](../assets/wiki/schem-tacho-2diode.jpg){ width="720" }
...
![Подключение тахометра: диоды и делитель R1/R2](../assets/wiki/schem-tacho-2diode-res.jpg){ width="720" }
