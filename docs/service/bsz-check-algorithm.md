...
![Перевернуть магниты: отталкивание от втулки](../assets/wiki/magnet-polarity-wrong.jpg){ width="420" }
...
![Разъём коммутатора](../assets/wiki/commutator-connector.jpg){ width="420" }
